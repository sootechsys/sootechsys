...
public class EgovSampleController {
	...
	public String moveJoinForm(@ModelAttribute("searchVO") SampleDefaultVO searchVO) throws Exception {
		return "sample/soo_join";
	}
	...
	public String retrieveLogin(@RequestParam Map<String, Object> param, SessionStatus status, HttpServletRequest request) throws Exception {
		...
		EgovMap login = sampleService.retrieveLogin(param);
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/egovSampleList.do",produces = "application/text; charset=utf8" )
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/addSample.do", method = RequestMethod.GET, produces = "application/text; charset=utf8" )
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/addSample.do", method = RequestMethod.POST, produces = "application/text; charset=utf8" )
